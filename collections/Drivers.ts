  ...
  fields: [
    {
      ...
      tabs: [
        ...
        {
          label: "Page Layout (Nouveau)",
          fields: [
            {
              name: "pageBlocks",
              type: "blocks",
              admin: {
                description: "Constructeur de page flexible. S'il est utilisé, il remplace le contenu Legacy de la page détail.",
              },
              blocks: [
                {
                  slug: "textMedia",
                  labels: { singular: "Texte + Média", plural: "Textes + Médias" },
                  fields: [
                    {
                      name: "textSections",
                      type: "array",
                    ...
                    },
                    {
                      ...
                      type: "select",
                      options: [
                        { label: "Image unique", value: "image" },
                        { label: "Galerie (3 images)", value: "gallery" },
                    ...
                    },
                    {
                      ...
                      type: "upload",
                      relationTo: "media",
                      admin: { condition: (_, siblingData) => siblingData.mediaType === "image" }
                    },
                    {
                      name: "gallery",
                      type: "array",
                      ...
                      admin: { condition: (_, siblingData) => siblingData.mediaType === "gallery" }
                    },
                    {
                      name: "mediaPosition",
                      type: "select",
                      ...
                      defaultValue: "right",
                      admin: { condition: (_, siblingData) => siblingData.mediaType !== "none" }
                    }
                  ]
                },
                {
                  slug: "textStats",
                  labels: { singular: "Texte + Statistiques", plural: "Textes + Statistiques" },
                  fields: [
                    {
                      name: "textSections",
                      type: "array",
                ...
                {
                  slug: "latestNews",
                  labels: { singular: "Dernières Actualités", plural: "Dernières Actualités" },
                  fields: [
                    { name: "title", type: "text", localized: true, defaultValue: "LATEST NEWS" },
                    {
                      name: "newsLinks",
                      type: "relationship",
                      relationTo: "news",
                      hasMany: true,
                      admin: {
                        description: "Sélectionnez les articles à afficher. Si vide, les 3 derniers articles seront affichés."
                      }
                    }
                  ]
                }
