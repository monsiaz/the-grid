...
export const newsCards: NewsCardItem[] = [
  {
    ...
    image: "/figma-assets/news/list-1.jpg",
    category: "sporting",
  },
  {
    ...
    image: "/figma-assets/news/list-2.jpg",
    category: "sporting",
  },
  {
    ...
    image: "/figma-assets/news/list-3.jpg",
    category: "sporting",
  },
  {
    ...
    image: "/figma-assets/news/list-4.jpg",
    category: "commercial",
  },
  {
...
export const newsDetailBySlug: Record<string, NewsDetailData> = {
  "stan-ratajski-joins-the-grid-agency": {
    ...
    title: "STAN RATAJSKI JOINS THE GRID AGENCY",
    date: "FEB 17, 2026",
    heroImage: "/figma-assets/news/detail-1.jpg",
    introParagraphs: [
    ...
    galleryImages: [
      "/figma-assets/news/detail-2.jpg",
      "/figma-assets/news/detail-3.jpg",
      "/figma-assets/news/detail-4.jpg",
      "/figma-assets/news/detail-5.jpg",
      "/figma-assets/news/detail-6.jpg",
    ],
  },
};
